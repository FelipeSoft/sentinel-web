...
const components: { title: string; href: string; description: string }[] = [
    {
        title: "Load Balancer",
        description: "Incoming requests across multiple servers",
        href: "/components/load-balancer/listing",
    },
    {
        title: "Circuit Breaker",
        description: "Preventing failures in microservices",
        href: "/",
    },
    {
        title: "Distributed Cache",
        description: "Response times by caching frequent data",
        href: "/",
    },
    {
        title: "Rate Limiter",
        description: "Management for request rate per IP",
        href: "/",
    },
    {
        title: "Service Discovery",
        description: "Track and manage available microservices",
        href: "/",
    },
]
